...
namespace Børne_Spil
{
    public partial class Form1 : Form
    {
        ...
        private void ResetTextBoxColors()
        {
            ...
            LABEL_COUNTDOWN.ForeColor = Color.Green;
            ...
            for (int row = 0; row < totalRows; row++)
            {
                ...
                for (int col = 0; col < totalColumns; col++)
                {
                    ...
                    if (number == RandomNumHighligt)
                    {
                        ...
                        Helping_Tool_mat.Rows[row].Cells[col].Style.BackColor = Color.Yellow; // Highlight the cell
                    }
        ...
        private void timer8_Tick(object sender, EventArgs e)
        {
            ...
            if (countdownTime > 0)
            {
                ...
                LABEL_COUNTDOWN.ForeColor = countdownTime <= 9 ? Color.Red : Color.Green;
            ...
            else
            {
                ...
                MessageBox.Show("Time's up ⏳!"); // Action when countdown reaches zero
                AnswerChecker.StreakScore = 0;
